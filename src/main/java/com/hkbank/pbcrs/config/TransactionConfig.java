...
public class TransactionConfig {
     ...
     * 切入点
     */
    private static final String AOP_POINTCUT_EXPRESSION = "( execution(* com.hkbank.pbcrs.service..*(..)) )||( execution(* com.hkbank.eism.service..*(..)) ) || ( execution(* com.hkbank.eism.interfaces..*(..)) )";
    /**
     * 需要添加事务切入的方法列表, 使用这些前缀的方法都会被添加事务 ,"insert*", "create*", "add*", "save*", "update*", "del*", "delete*"
     */
