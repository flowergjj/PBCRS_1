...
<script type="text/javascript" src="${ctx}/js/dataTestQuery/IndBaseInfoTable.js"></script>
...
<body style="padding:0px;">
		<div class="easyui-layout" style="padding: 0px; border:1px solid rgb(149, 184, 231)"
			...
			<table class="queryTable" style="width: 100%;">
				<tr>
					...
					<td style="width: 130px"><input id="queryDate"
		...
		<div  class="easyui-layout"
			...
			<h2 style="margin: 0px" align="center">个人基本信息填报情况表</h2>
			<table id="indBaseInfo" style="width: 100%;" data-options="nowrap:false">
			</table>
