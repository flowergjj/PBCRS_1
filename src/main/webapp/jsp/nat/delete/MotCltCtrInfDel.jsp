...
<script type="text/javascript" src="${ctx}/js/nat/delete/MotCltCtrInfDel.js"></script>
<title>个人抵质押物信息删除</title>
</head>
<body>
	<div class="easyui-layout" fit="true">
		<div id="cc" class="easyui-layout" style="padding: 0px;"
			data-options="region: 'north'">
				...
				<div  style="padding: 2px;width:85px; display: inline-block;">&nbsp;债务人姓名:</div>
				<div style="padding: 2px; display: inline-block;">
					<input id="queryName" class="easyui-textbox"  style="width: 120px;" />
				</div>
				<div  style="padding: 2px;width:120px; display: inline-block;">&nbsp;债务人身份标识号码:</div>
				<div
					style="padding: 2px; vertical-align: middle; display: inline-block;">
					<input id="queryCertNum" class="easyui-textbox" style="width: 150px" />
				</div>
				<div  style="padding: 2px;width:120px; display: inline-block;">&nbsp;系统:</div>
				<div
					style="padding: 2px; vertical-align: middle; display: inline-block;">
