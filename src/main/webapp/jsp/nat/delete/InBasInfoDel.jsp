...
<script type="text/javascript" src="${ctx}/js/nat/delete/InBasInfoDel.js"></script>
<title>个人基本信息删除</title>
</head>
<body>
		...
		<div id="cc" class="easyui-layout" style="padding: 0px;"
			...
			<div>
				<div  style="padding: 2px; display: inline-block;">
					&nbsp;信息报告日期:</div>
				<div style="padding: 2px; display: inline-block;">
					<input id="queryDate" type="text" class="easyui-datebox" data-options="editable:false"
						style="width: 120px" />
				</div>
				...
				<div
					...
					<input id="queryNum" class="easyui-textbox" style="width: 150px" />
				</div>
			...
			<div style="padding-bottom:5px;display: none;">
					...
					<div  style="padding: 2px; display: inline-block;">
						&nbsp;信息所属机构:</div>
					<div style="padding: 2px; display: inline-block;">
						<input id="queryCimoc" class="easyui-combobox" style="width: 120px" />
					</div>
