...
<script type="text/javascript" src="${ctx}/js/nat/modify/InAcctInf.js"></script>
<title>个人借贷信息维护</title>
</head>
<body>
	...
	<div class="easyui-layout"
		 data-options="region: 'north', border: false">
			<div style="padding: 2px 0 ">
				...
				<div style="display: inline-block;margin-right:10px">&nbsp;姓名:<input id="queryName" class="easyui-textbox"  style="width: 120px;" /></div>
				<div style="display: inline-block;margin-right:10px">&nbsp;证件号码:<input id="queryIDNum" class="easyui-textbox" style="width: 150px" /></div>
				<div style="display: none;margin-right:10px">&nbsp;系统:<input id="reportSys" class="easyui-combobox" style="width: 150px" /></div>
				<div style="display: inline-block;margin-right:10px">&nbsp;借据号:<input id="acctCode" class="easyui-textbox" style="width: 120px" /></div>
