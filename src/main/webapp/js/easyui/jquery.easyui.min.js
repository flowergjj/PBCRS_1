...
//_468.css({paddingTop:"0px",paddingBottom:"1px",marginTop:"3px"});
_468.css({padding:"0px", paddingLeft:"3px", height:tb.height()+'px', lineHeight:tb.height()+'px',verticalAlign:'middle'});
}
...
$.ajax({url:data,data:_4c1,dataType:"json",cache:false,success:function(data){
_4c2(data);
},error:function(){
